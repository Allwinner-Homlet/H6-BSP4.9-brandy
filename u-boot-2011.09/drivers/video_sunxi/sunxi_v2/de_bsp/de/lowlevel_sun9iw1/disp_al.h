...
#define DISP2_CTRL0 0x03000030
#define DISP2_CTRL1 0x03000034
#define DISP2_CTRL2 0x03000038
#define DISP2_CTRL3 0x0300003c
...
s32 disp_al_query_cmu_mod(u32 screen_id);
...
/* scal_info define */
//s32 disp_al_layer_set_scale_info();

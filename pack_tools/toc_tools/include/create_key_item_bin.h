#ifndef _CREATE_KEY_ITEM_BIN_
#define _CREATE_KEY_ITEM_BIN_
...
extern int prode_toc_key_item(char *lpCfg);
extern int creat_key_item_bin(toc_key_item_descriptor_t *toc0);
